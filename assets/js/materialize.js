...
(function (r) {
  ...
  function e (a) {
    ...
    var g = fa(a); g.reset = function () {
      ...
      var c = g.loop; g.currentTime = 0; g.progress = 0; g.paused = !0; g.began = !1; g.completed = !1; g.reversed = a === 'reverse'; g.remaining = a === 'alternate' && c === 1 ? 2 : c; b(0); for (a = g.children.length; a--;) {
        g.children[a].reset()
      }
    }; g.tick = function (a) {
    ...
    function a (a, d, b) {
      ...
      if (c >= 0 && c <= 1 && b >= 0 && b <= 1) {
        var e = new Float32Array(11); if (c !== d || b !== f) {
          ...
          var n = 3 * (1 - 3 * b + 3 * c) * l * l + 2 * (3 * b - 6 * c) * l + 3 * c; if (n >= 0.001) {
            for (h = 0; h < 4; ++h) {
  ...
  var Q = (function () {
    ...
    var d = { In: [[0.55, 0.085, 0.68, 0.53], [0.55, 0.055, 0.675, 0.19], [0.895, 0.03, 0.685, 0.22], [0.755, 0.05, 0.855, 0.06], [0.47, 0, 0.745, 0.715], [0.95, 0.05, 0.795, 0.035], [0.6, 0.04, 0.98, 0.335], [0.6, -0.28, 0.735, 0.045], a],
    ...
    var b = { linear: A(0.25, 0.25, 0.75, 0.75) }
    ...
    _createClass(Dropdown, [{
      ...
      value: function _handleDropdownKeydown (e) {
        ...
        if (letter && nonLetters.indexOf(e.which) === -1) {
          ...
          var newOptionEl = $(this.dropdownEl).find('li').filter(function (el) {
  ...
  var ScrollSpy = (function (_Component9) {
    ...
    _createClass(ScrollSpy, [{
      ...
      value: function _handleWindowScroll () {
        ...
        var left = M.getDocumentScrollLeft()
      ...
      value: function _findElements (top, right, bottom, left) {
        ...
        for (var i = 0; i < ScrollSpy._elements.length; i++) {
          ...
          if (scrollspy.$el.height() > 0) {
            ...
            var elLeft = scrollspy.$el.offset().left

            var elRight = elLeft + scrollspy.$el.width()

            var elBottom = elTop + scrollspy.$el.height()
  ...
  var Datepicker = (function (_Component15) {
    ...
    _createClass(Datepicker, [{
      ...
      value: function render (year, month, randId) {
        ...
        var days = Datepicker._getDaysInMonth(year, month)
        ...
        var daysInPreviousMonth = Datepicker._getDaysInMonth(yearOfPreviousMonth, previousMonth)
        ...
        for (var i = 0, r = 0; i < cells; i++) {
          ...
          var isSelected = Datepicker._isDate(this.date) ? Datepicker._compareDates(day, this.date) : false

          var isToday = Datepicker._compareDates(day, now)
          ...
          var isStartRange = opts.startRange && Datepicker._compareDates(opts.startRange, day)

          var isEndRange = opts.endRange && Datepicker._compareDates(opts.endRange, day)

          var isInRange = opts.startRange && opts.endRange && opts.startRange < day && day < opts.endRange

          var isDisabled = opts.minDate && day < opts.minDate || opts.maxDate && day > opts.maxDate || opts.disableWeekends && Datepicker._isWeekend(day) || opts.disableDayFn && opts.disableDayFn(day)
      ...
      value: function renderTitle (instance, c, year, month, refYear, randId) {
        ...
        var html = '<div id="' + randId + '" class="datepicker-controls" role="heading" aria-live="assertive">'
  ...
  var Timepicker = (function (_Component16) {
    ...
    _createClass(Timepicker, [{
      ...
      value: function resetClock (delay) {
        ...
        var radius = isHours && value > 0 && value < 13 ? this.options.innerRadius : this.options.outerRadius
      ...
      value: function setHand (x, y, roundBy5) {
        ...
        var inner = isHours && z < (this.options.outerRadius + this.options.innerRadius) / 2

        var radius = inner ? this.options.innerRadius : this.options.outerRadius
        ...
        var cy1 = -Math.cos(radian) * (radius - this.options.tickRadius)
  ...
  var Carousel = (function (_Component18) {
    ...
    _createClass(Carousel, [{
      ...
      value: function _scroll (x) {
        ...
        var tweenedOpacity = void 0

        var centerTweenedOpacity = void 0
